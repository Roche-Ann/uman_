...
<!-- ── Scripts ─────────────────────────────────────────────────────────────── -->
<script>
window.USER_PROFILE_CONFIG = {
    errFullName:      <?php echo json_encode(_prt('err_full_name')); ?>,
    errEmailInvalid:  <?php echo json_encode(_prt('err_email_invalid')); ?>,
    errPwTooShort:    <?php echo json_encode(_prt('err_pw_too_short')); ?>,
    errPwComplexity:  <?php echo json_encode(_prt('err_pw_complexity')); ?>,
    pwNoMatch:        <?php echo json_encode(_prt('pw_no_match')); ?>,
    ...
    showPasswordError: <?php echo (!empty($errors) && isset($_POST['action']) && $_POST['action'] === 'change_password') ? 'true' : 'false'; ?>,
    showProfileError:  <?php echo (!empty($errors) && isset($_POST['action']) && $_POST['action'] === 'update_profile')  ? 'true' : 'false'; ?>
};
</script>
<script src="/lgu-urban-planning/assets/js/user-profile.js"></script>
