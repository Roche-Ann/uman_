...
// ── QUEZON CITY BOUNDARY ── (source: GIS Mapping module, map.php) ──────────
...
// Convert [lng, lat] pairs to Leaflet [lat, lng] format for the boundary polygon
const qcBoundaryLatLngs = QC_BOUNDARY_COORDS.map(c => [c[1], c[0]]);

document.addEventListener('DOMContentLoaded', function () {
    let map, marker, qcBoundaryLayer;
    ...
    btnMap.addEventListener('click', function () {
        ...
        if (isHidden) {
            ...
            if (!map) {
                ...
                // Quezon City boundary — same style/source as the GIS Mapping module
                qcBoundaryLayer = L.polygon(qcBoundaryLatLngs, {
