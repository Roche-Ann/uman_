...
(function() {
    ...
    // Always hide spinner on initial load, DOM ready, and crucially on pageshow (BFCache back/forward navigation)
    ...
    // When navigating away, reveal spinner with safety failsafe timeout
